# widgets/help_widget.py (исправлен - обновлены примеры)
# Python 3.11+, PyQt6
...
TCP запрос (чтение 2 регистров с адреса 0x0FA0 (4000)):
  03E50000000601030FA00002

TCP ответ (значения регистров: 7 и 3):
  03E60000000701030400070003

RTU запрос (без CRC, Slave ID=01, чтение 2 регистров с адреса 4000):
  01030FA00002

RTU ответ (без CRC, значения регистров: 7 и 3):
  01030400070003
...
ASCII запрос (чтение 2 регистров с адреса 0000):
  :010300000002FA

ASCII ответ (значения регистров: 7 и 3):
  :01030400060005ED

ASCII запрос (с явным указанием стартового символа 3A):
  3A01030FA00002FA0D0A

ASCII запрос (альтернативный формат):
  :01030FA00002FA\r\n
